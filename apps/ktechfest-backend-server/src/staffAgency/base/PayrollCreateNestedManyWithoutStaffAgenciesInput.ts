...
@InputType()
class PayrollCreateNestedManyWithoutStaffAgenciesInput {
...
export { PayrollCreateNestedManyWithoutStaffAgenciesInput as PayrollCreateNestedManyWithoutStaffAgenciesInput };
