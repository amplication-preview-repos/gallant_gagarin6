...
@InputType()
class ApplicationUpdateManyWithoutStaffAgenciesInput {
...
export { ApplicationUpdateManyWithoutStaffAgenciesInput as ApplicationUpdateManyWithoutStaffAgenciesInput };
