...
@InputType()
class PayrollCreateNestedManyWithoutStaffItemsInput {
...
export { PayrollCreateNestedManyWithoutStaffItemsInput as PayrollCreateNestedManyWithoutStaffItemsInput };
